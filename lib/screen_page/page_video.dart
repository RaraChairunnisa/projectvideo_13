...
class _PageLatVideoState extends State<PageLatVideo> {
  ...
  Future<void> _fetchVideoData() async {
    try {
      final response = await http.get(Uri.parse('http://192.168.1.9/videoDB/getVideo.php'));
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => VideoPlayerPage(
                    videoUrl:
                    'http://192.168.1.9/videoDB/video_file/${_videoList[index].videoFile}',
                  ...
                  Stack(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: Image.network(
                          'http://192.168.1.9/videoDB/gambar/${_videoList[index].gambar}',
                          fit: BoxFit.cover,
                          height: 200,
                        ),
                      ),
